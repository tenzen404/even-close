  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <span>
        ...
        to quickly output your stats and talents, as well as your teammates&apos;. Import
        them by clicking the paste icon to the right of the character stats, or by
        pressing ctrl-V/cmd-V if you only have 1 character. It accounts for vers flask,
        Fortitude and Mark of the Wild.
      </span>
      <span>
